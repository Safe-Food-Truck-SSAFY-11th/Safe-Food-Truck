...
const RegistUser = () => {
  const { form, setForm, emailChecked, checkEmail, passwordMatch, emailTouched, setEmailTouched, passwordTouched, setPasswordTouched, nicknameChecked, nicknameTouched, setNicknameTouched, checkNickname } = useCustomerStore();
