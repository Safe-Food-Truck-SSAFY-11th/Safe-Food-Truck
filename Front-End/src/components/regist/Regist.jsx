...
const Regist = () => {
    ...
    const { isGuest, setGuest, setOwner, fetchUser, registerUser, emailValid, emailChecked, nicknameChecked, passwordMatch } = useUserStore();
    ...
    const isFormValid = emailValid && emailChecked === 'Possible' && nicknameChecked === 'Possible' && passwordMatch && (isGuest || formData.bsNumValid);
