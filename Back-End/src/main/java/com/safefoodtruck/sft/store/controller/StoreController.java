...
public class StoreController {
	...
	public ResponseEntity<Void> registStore(
		@RequestBody StoreRegistRequestDto storeRegistRequestDto) {
	...
	@ApiResponses(value = {
		@ApiResponse(responseCode = "200", description = "Duplicate: 중복 | Possible: 해당 인허가 번호 사용가능", content = @Content(mediaType = "application/json"))})
	public ResponseEntity<String> isDuplicateSafetyLicenseNumber(
		@PathVariable("safety-license-number") String safetyLicenseNumber) {
		String responseMessage = storeService.checkDuplicateSafetyLicenseNumber(
			safetyLicenseNumber);
	...
	@ApiResponses(value = {
		...
		@ApiResponse(responseCode = "500", description = "Error Message 로 전달함", content = @Content(mediaType = "application/json"))})
	public ResponseEntity<MenuListResponseDto> findStoreMenus(
		@PathVariable("storeId") Integer storeId) {
	...
	@ApiResponses(value = {
		...
		@ApiResponse(responseCode = "500", description = "Error Message 로 전달함", content = @Content(mediaType = "application/json"))})
	public ResponseEntity<Void> updateStoreNotice(
		@RequestBody StoreNoticeRegistRequestDto storeNoticeRegistRequestDto) {
	...
	@ApiResponses(value = {
		...
		@ApiResponse(responseCode = "500", description = "Error Message 로 전달함", content = @Content(mediaType = "application/json"))})
	public ResponseEntity<StoreNoticeResponseDto> findStoreNotice(
		@PathVariable("storeId") Integer storeId) {
	...
	public ResponseEntity<StoreUpdateResponseDto> updateStore(
		...
		StoreUpdateResponseDto storeUpdateResponseDto = storeService.updateStore(
			storeUpdateRequestDto);
		return new ResponseEntity<>(storeUpdateResponseDto, OK);
	}
	...
	public ResponseEntity<Boolean> getStoreStatus() {
		Boolean isOpen = storeService.getStoreStatus();
		return new ResponseEntity<>(isOpen, OK);
	}
	...
	@ApiResponses(value = {
		...
		@ApiResponse(responseCode = "500", description = "Error Message 로 전달함", content = @Content(mediaType = "application/json"))})
	public ResponseEntity<Void> updateStoreLocation(
		@RequestBody StoreLocationRequestDto storeLocationRequestDto) {
	...
	public ResponseEntity<ErrorResponseDto> handleStoreException(Exception e) {
		ErrorResponseDto errorResponse = new ErrorResponseDto(INTERNAL_SERVER_ERROR.value(),
